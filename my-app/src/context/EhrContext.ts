...
export type MedicationItem = {
  medication: string;
  medicationId: string;
  statusMedication: "active" | "completed" | "entered-in-error" | "intended" | "stopped" | "on-hold" | "unknown";
  dosageInstructions: string;
  route?: "oral" | "intravenous" | "subcutaneous" | "topical" | "nasal" | "ophthalmic" | "transdermal" | "rectal" | "sublingual" | "other";
  startDate: string;
  endDate?: string;
