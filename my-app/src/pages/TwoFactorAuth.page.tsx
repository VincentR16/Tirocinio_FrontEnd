...
export default function TwoFactorAuthPage() {
  ...
  return (
    <Flex direction="column" gap="md"  miw="100%">
      <Paper mt="xl" p="md" shadow="md">
        <Blockquote color="indigo" icon={icon}>
          Here you can register your device with the authenticator app to enable
          ...
          <br />
          <br />
          2. <strong>Open the authenticator app</strong> and tap the "+" or "Add
          account" button
          <br />
          <br />
          3. <strong>Select "Scan QR code"</strong> or "Scan barcode" option in
          your authenticator app
          <br />
          <br />
          4. <strong>Point your phone's camera</strong> at the QR code displayed
          on this screen
          <br />
          <br />
